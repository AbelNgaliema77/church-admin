...
public sealed class UsersController : ControllerBase
{
    ...
    public async Task<ActionResult<UserResponse>> Create(CreateUserRequest request)
    {
        ...
        response.InviteLink = BuildInviteLink(inviteToken);
    ...
    private string BuildInviteLink(string inviteToken)
    {
        ...
        {
            throw new InvalidOperationException("Frontend__BaseUrl must be configured before user invites can be sent.");
        }

        string baseUrl = _frontendSettings.BaseUrl.TrimEnd('/');
        string encodedToken = Uri.EscapeDataString(inviteToken);
