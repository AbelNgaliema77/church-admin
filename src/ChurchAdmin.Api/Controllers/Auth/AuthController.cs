...
public sealed class AuthController : ControllerBase
{
    ...
    private readonly IValidator<DevLoginRequest> _devValidator;
    ...
    public AuthController(
        ...
        IValidator<DevLoginRequest> devValidator,
    ...
    [HttpPost("dev-login")]
    public async Task<ActionResult<AuthResponse>> DevLogin(DevLoginRequest request)
    {
        FluentValidation.Results.ValidationResult validation =
            await _devValidator.ValidateAsync(request);
